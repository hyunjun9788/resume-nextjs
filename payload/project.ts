      ...
      descriptions: [
        {
          ...
          descriptions: [
            {
              content:
                'SMS 재요청 제한 응답을 기반으로 서버 잔여시간과 클라이언트 타이머를 동기화해\n 새로고침·재진입 시에도 제한 상태 유지',
            },
            {
              content:
                '로그인·예약 화면의 중복 본인인증 로직을 mode prop 기반 단일 컴포넌트로 통합해 재사용성 확보',
            },
            // {
            //   content:
      ...
      descriptions: [
        ...
        // },
        {
          ...
          descriptions: [
            {
              content:
                '예약 등록·컴플레인 상담·멤버십 양도·현장 접수 등 6개 이상 화면에 중복된 고객 검색 기능 공통화',
            },
            {
              content:
