        ...
        <Col sm={12} md={9}>
          {payload.contents.map((_, index) => (
            <p key={index.toString()}>
              팀원들이 효율적이고 안전하게 코드를 사용할 수 있도록, 타입스크립트를 활용해 이미지,
              아이콘, 카드 섹션 등 다양한 공통 컴포넌트를 설계하고 구현한 경험이 있습니다. 이러한
              작업들을 PR에 상세하게 기록하였으며, 팀원들로부터 시간 단축 및 안전성을 높였다는
              긍정적인 피드백을 받았습니다.
              <br />
              <br /> 사용자 경험(UX)을 최우선으로 고려하며 성능 최적화를 깊이 고민하고 개발에 임하고
              있습니다. 특히, 기존 1.8초가 소요되던 이미지 업로드 기능을 Next.js의 이미지 최적화를
              적용해 1.1초로 개선하여 <span style={{ fontWeight: 'bold' }}>약 38.7% </span>
              성능 향상을 이루었습니다.
              <br />
